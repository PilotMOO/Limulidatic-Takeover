...
public class HorseshoeEntities {
    ...
    public static final RegistryObject<EntityType<NodeVisualizerEntity>> NODE_VISUALIZER =
            ENTITY_TYPES.register("node_visualizer", () -> EntityType.Builder.of(NodeVisualizerEntity::new, MobCategory.MISC)
                    .sized(0.2f, 0.2f).build("node_visualizer"));
