        ...
        if (grid != null && grid.grid != null) {
            for (Basic2DNode[] nodes : grid.grid) {
                for (Basic2DNode node : nodes) {
                    ...
                    //poseStack.translate(-crab.getX(), -crab.getY(), -crab.getZ());
                    poseStack.translate(bPos.getX() + .5, bPos.getY() + .5, bPos.getZ() + .5);
                    ...
                    drawTaperedCube(buffer.getBuffer(RenderType.lightning()),
                            ...
                            OverlayTexture.NO_OVERLAY, getPackedLightCoords(crab, partialTicks),
                            r, g, b, .25f,
                            0, 1, 0, 1);
                    poseStack.popPose();
                }
