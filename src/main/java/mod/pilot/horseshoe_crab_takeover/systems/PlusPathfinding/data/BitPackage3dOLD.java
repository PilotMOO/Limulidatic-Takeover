...
/**
 * <p>NOTE! THIS ONE IS DEPRECATED AS IT IS INEFFICIENT. USE {@link BitPackage3d} INSTEAD</p>
 ...
 */
@Deprecated
public class BitPackage3dOLD<T> {
    /**
     ...
     */
    public BitPackage3dOLD(int bitsPerObject, int sizeX, int sizeY, int sizeZ, Function<T, boolean[]> to, Function<boolean[], T> from){
        bits = new boolean[
                (this.sizeX = sizeX) *
                (this.sizeY = sizeY) *
                (this.sizeZ = sizeZ) *
    ...
    /**The amount of bit indexes to skip when moving +1 on the X|Y axis. No step value for the Z axis as it is identical to {@link BitPackage3dOLD#bitsPerObject}*/
    ...
    /**
     * Same as {@link BitPackage3dOLD#computeIndex(int, int, int)}
     ...
     * as used in {@link BitPackage3dOLD#readObject(int, int, int)}
     * <p>Shorthand, computes the contextual index then invokes {@link BitPackage3dOLD#readBits(int)}</p>
     * @param x The X coordinate of the object
     * @param y The Y coordinate of the object
     * @param z The Z coordinate of the object
     ...
     * as used in {@link BitPackage3dOLD#readObject(int)}
    ...
    /**
     * Same as {@link BitPackage3dOLD#readBits(int, int, int)}, but uses the faster, UNSAFE method to compute the contextual index.
     ...
     * <p>Shorthand, computes the contextual index then invokes {@link BitPackage3dOLD#writeBits(int, boolean[])}</p>
     * @param x The X coordinate of the object
     * @param y The Y coordinate of the object
     * @param z The Z coordinate of the object
    ...
    /**
     * An unsafe variant of {@link BitPackage3dOLD#writeBits(int, int, int, boolean[])} that writes ALL the bits to the BitPackage
     * and will not truncate the copying to the expected {@link BitPackage3dOLD#bitsPerObject}.
     ...
     * Shorthand, computes the contextual index then invokes {@link BitPackage3dOLD#writeBitsUNSAFE(int, boolean[])}
     * @param x The X coordinate of the object
     * @param y The Y coordinate of the object
     * @param z The Z coordinate of the object
     * @param ink The bit array (boolean array) of bits to "write" in the position of the old bits at the supplied coordinate index
    ...
    /**
     * An unsafe variant of {@link BitPackage3dOLD#writeBits(int, boolean[])} that writes ALL the bits to the BitPackage
     * and will not truncate the copying to the expected {@link BitPackage3dOLD#bitsPerObject}.
     * <p>Only use if you want to modify more than 1 object at once, and ONLY if you KNOW what you are doing.
     * May modify/corrupt other bits if used in cases where the safety of the index bounds are uncertain</p>
     * @param index The contextual index of the object to write over
     ...
     * as defined by the {@link BitPackage3dOLD#fromBits} function
     * @param x The X coordinate of the object
     * @param y The Y coordinate of the object
     * @param z The Z coordinate of the object
     ...
     * <p>MAKE SURE the supplied toBits function's array is of the same length as the BitPackage's {@link BitPackage3dOLD#bitsPerObject}!</p>
    ...
    /**
     * An unsafe variant of {@link BitPackage3dOLD#writeObject(int, int, int, Object)} that uses the unsafe methods for better performance.
     ...
     * <p>MAKE SURE the resulting bit array has the same length as the {@link BitPackage3dOLD#bitsPerObject} within the related BitPackage</p>
     */
     ...
     * <p>The supplied bit array should have the same length as the {@link BitPackage3dOLD#bitsPerObject} within the related BitPackage</p>
     */
